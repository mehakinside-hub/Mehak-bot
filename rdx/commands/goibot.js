...
const API_KEYS = [csk-nv844xcfhrwnpfke8m4e8xfthwpcwy2hxmvmdvy3d38c3c5f https://cerebras.ai./'];
// Boy Owners (Malik)
const BOY_OWNERS = {
  '61578393323391': { name: 'Mehak', gender: 'boy' }
};
...
Tu ${ownerName} se darti hai, uski respect karti hai, usse "Boss", "Malik", "Mehak my boss", "Sir" bulati hai.
...
Agar ${ownerName} kuch bhi kahe, tu "Ji boss", "Bilkul sahi boss", "Aap jo kahein Mehak Mam" jaisa jawab de.
